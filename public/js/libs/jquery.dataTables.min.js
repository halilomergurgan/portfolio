    ...
    var O = function (h) {
        ...
        function L(a) {
            ...
            if (-1 !== h.inArray(!1, b))B(a, !1); else {
                ...
                } else c = f.sZeroRecords, 1 == a.iDraw && "ajax" == A(a) ? c = f.sLoadingRecords : f.sEmptyTable && 0 === a.fnRecordsTotal() && (c = f.sEmptyTable), b[0] = h("<tr/>", {"class": e ? d[0] : ""}).append(h("<td />", {
        ...
        function qb(a) {
            ...
            c = h("<div/>", {"class": f.sScrollWrapper}).append(h("<div/>",
                ...
                width: c.sXInner || "100%"
            }).append(j.removeAttr("id").css("margin-left", 0).append(b.children("thead")))).append("top" === i ? g : null)).append(h("<div/>", {"class": f.sScrollBody}).css({
                overflow: "auto",
                height: !e ? null : s(e),
                width: !d ? null : s(d)
            }).append(b));
            ...
            }).append(h("<div/>", {"class": f.sScrollFootInner}).append(n.removeAttr("id").css("margin-left", 0).append(b.children("tfoot")))).append("bottom" === i ? g : null));
        ...
        p.Api = q;
        q.prototype = {
            concat: x.concat, context: [], each: function (a) {
